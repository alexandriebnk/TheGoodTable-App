class NewRestaurant {
  constructor() {
    // Elements du DOM
    this.layoutNewRestaurant = document.querySelector(".newRestaurant");
    this.nameInput = document.getElementById("newRestaurant__elements-content");
    this.validateButton = document.querySelector(".newRestaurant__validation");
    this.cancelButton = document.querySelector(".newRestaurant__annulation");
    // Datas //
  ...
  checkRegExInput() {
    ...
    if (this.nameInput.value.length >= 2 && regEx.test(this.nameInput.value)) {
  ...
  disableValidation() {
    this.validateButton.style.border = ".1rem solid rgb(147, 142, 142)";
